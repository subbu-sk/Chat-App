...
import { getAgoTime } from "../config/helper";
const ChatPage = () => {
  const {
    roomId,
    currentUser,
  ...
  return (
    <div className="">
      ...
      <main
        ref={chatBoxRef}
        className="py-20 px-10   w-2/3 dark:bg-slate-800 mx-auto h-screen overflow-auto no-scrollbar " style={{ scrollbarWidth: "none" }}
      >
        {messages.map((message, index) => (
          ...
          >
            <div className={`my-2 ${message.sender === currentUser ? "bg-purple-800" : "bg-green-800"}
...
>
      ...
      <div className=" fixed bottom-1 w-full h-12 text-white">
        <div className="h-full  pr-10 gap-4 flex items-center justify-between rounded-full w-1/2 mx-auto ">
          <input
            ...
            className=" w-full  dark:border-gray-600 b dark:bg-gray-900  px-5 py-2 rounded-full h-full focus:outline-none  "
          />
